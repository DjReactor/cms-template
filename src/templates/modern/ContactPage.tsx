    ...
    <div className="py-20 bg-white">
      <div className={styles.container}>
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-slate-600">{resolvedCopy.subheading}</p>
        </div>

        <div className="grid lg:grid-cols-5 gap-12 items-start">
          <div className="lg:col-span-3 bg-slate-50 p-8 md:p-12 rounded-3xl border border-slate-100 shadow-lg">
            <ContactForm />
          </div>

          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
              <h3 className="font-bold text-xl text-slate-900 border-b border-slate-100 pb-4">Contact Info</h3>
        ...
        {businessInfo.google_maps_url && (
          <div className="mt-20">
            {embedUrl ? (
              <div className="w-full h-96 rounded-2xl overflow-hidden shadow-sm border border-slate-200">
                <iframe 
                  src={embedUrl}
                  width="100%" 
                  height="100%" 
