  ...
  return (
    <div className="bg-white pb-24">
        ...
        {!services || services.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services?.map((service) => (
              ...
              >
                {service.icon && (
                  <div className="w-16 h-16 rounded-xl bg-blue-50 flex items-center justify-center text-3xl mb-8 text-[#2D6A4F] group-hover:scale-110 transition-transform duration-300">
                    {service.icon}
                  </div>
                )}
                ...
                <div className="mt-auto flex items-center gap-2 font-semibold text-[#2D6A4F] group-hover:gap-3 transition-all duration-300">
      ...
      <section className="max-w-4xl mx-auto px-6">
        <div className="bg-[#2D6A4F] rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl">
