  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-16 pb-12 text-center">
        <Link href="/blog" className="inline-flex items-center gap-2 text-sm font-semibold text-[#2D6A4F] hover:text-gray-900 mb-8 transition-colors">
      ...
      <article className="max-w-3xl mx-auto px-6 pb-20">
        {post.content ? (
          <div className="prose prose-lg md:prose-xl prose-[#2D6A4F] prose-img:rounded-2xl max-w-none">
              ...
              {relatedPosts?.map((related) => (
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="font-heading font-bold text-xl text-gray-900 group-hover:text-[#2D6A4F] transition-colors">
                      {related.title}
                    </h3>
                  </div>
                </Link>
      ...
      {/* CTA Banner */}
      <section className="bg-[#2D6A4F] py-20 px-6 text-center text-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact" className="px-8 py-4 bg-white text-[#2D6A4F] font-bold rounded-lg hover:bg-gray-50 transition-colors">
              Get in Touch
            </Link>
            {businessInfo.phone && (
