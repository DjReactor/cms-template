        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center text-sm font-medium text-gray-400">
              ...
              <span className="text-[#B9FF24]">Service</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
            ...
            <div className="max-w-md">
              ...
              <Link href="/contact" className="inline-flex items-center bg-gray-900 hover:bg-gray-800 text-white rounded-full pl-6 pr-2 py-2 transition-all">
            ...
            {services.map(service => (
              <div key={service.id} className="group relative rounded-3xl overflow-hidden shadow-lg h-[400px]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  ...
                  <Link href={`/services/${service.slug}`} className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#B9FF24] text-gray-900 hover:bg-white transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm flex flex-col h-full">
              ...
              <Link href="/contact" className="bg-gray-900 text-white hover:bg-gray-800 text-center py-3 rounded-full font-medium transition-colors w-full">Book Service</Link>
            </div>
            ...
            <div className="bg-[#0A1A12] rounded-3xl p-8 shadow-xl flex flex-col h-full transform md:-translate-y-4 border border-gray-800 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#B9FF24] rounded-full filter blur-[80px] opacity-20"></div>
              <div className="inline-block bg-[#B9FF24] text-gray-900 text-xs font-bold px-3 py-1 rounded-full w-max mb-4">Most Popular</div>
              <h3 className="font-bold text-white mb-2">Standard Service</h3>
              ...
              <Link href="/contact" className="bg-[#B9FF24] text-gray-900 hover:bg-white text-center py-3 rounded-full font-bold transition-colors w-full">Get Started</Link>
            </div>
