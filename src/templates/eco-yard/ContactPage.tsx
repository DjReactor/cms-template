        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center text-sm font-medium text-gray-400">
              ...
              <span className="text-[#B9FF24]">Contact Us</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-4">
              {/* Primary Office */}
              <div className="bg-[#B9FF24] rounded-2xl p-6 shadow-sm">
              ...
              {serviceAreas.slice(0, 3).map((area, idx) => (
                <div key={idx} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-[#B9FF24] transition-colors cursor-pointer group">
                  <div className="flex justify-between items-center">
                    <h3 className="font-bold text-gray-900 text-lg">{area.name} Office</h3>
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-[#B9FF24]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg>
                  </div>
                </div>
              ))}
            </div>
